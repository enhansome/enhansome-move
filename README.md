...
* [Sui](https://github.com/MystenLabs/sui) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 - A next-generation smart contract platform with high throughput, low latency, and an asset-oriented programming model powered by the Move programming language (in [devnet](https://medium.com/mysten-labs/sui-devnet-public-release-a2be304ff36b)).
* [Aptos](https://github.com/aptos-labs/aptos-core) ⭐ 6,433 | 🐛 562 | 🌐 Rust | 📅 2026-09-19 - Aptos-core strives towards being the safest and most scalable layer one blockchain solution (in [mainnet](https://explorer.aptoslabs.com/?network=mainnet)).
...
* [Fungible token examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/fungible_tokens) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 - Multiple example token implementations from Sui.
...
* [NFT examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/nfts) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 - Multiple NFT example implementations from Sui.
...
* [DeFi examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/defi) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 - Multiple DeFi example implementations from Sui.
...
* [Sui Framework](https://github.com/MystenLabs/sui/tree/main/crates/sui-framework) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19
* [Aptos Framework](https://github.com/aptos-labs/aptos-core/tree/main/aptos-move/framework) ⭐ 6,433 | 🐛 562 | 🌐 Rust | 📅 2026-09-19
...
* [Sui Wallet](https://github.com/MystenLabs/sui/tree/main/apps/wallet) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 - A chrome (v88+) extension wallet for Sui ([Chrome Webstore](https://chrome.google.com/webstore/detail/sui-wallet/opcgpfmipidbgpenhmajoajpbobppdil)).
...
* [Sui Wallet](https://github.com/MystenLabs/sui/tree/main/sdk/wallet-adapter) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 - Sui Wallet Adapter.
...
* [TS/JS SDK](https://github.com/MystenLabs/sui/tree/main/sdk/typescript) ⭐ 7,750 | 🐛 852 | 🌐 Rust | 📅 2026-09-19 (official)
