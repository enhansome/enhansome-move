...
* [Diem](https://github.com/diem/diem) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - The original Move based blockchain from Meta (form. Libra by Facebook) (discontinued).
* [Sui](https://github.com/MystenLabs/sui) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 - A next-generation smart contract platform with high throughput, low latency, and an asset-oriented programming model powered by the Move programming language (in [devnet](https://medium.com/mysten-labs/sui-devnet-public-release-a2be304ff36b)).
* [Aptos](https://github.com/aptos-labs/aptos-core) ⭐ 6,428 | 🐛 557 | 🌐 Rust | 📅 2026-09-02 - Aptos-core strives towards being the safest and most scalable layer one blockchain solution (in [mainnet](https://explorer.aptoslabs.com/?network=mainnet)).
...
* [Celo](https://github.com/celo-org/celo-blockchain) ⭐ 627 | 🐛 13 | 🌐 Go | 📅 2026-09-02 - Blockchain with EVM and MoveVM ([coming soon](https://www.businesswire.com/news/home/20210921006104/en/Celo-Sets-Sights-On-Becoming-Fastest-EVM-Chain-Through-Collaboration-With-Mysten-Labs)).
...
* [Fungible token examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/fungible_tokens) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 - Multiple example token implementations from Sui.
...
* [NFT](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/NFT.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - An implementation of a hybrid ERC721/ERC1155-like token. From Diem.
* [BARS](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/BARS.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - An NFT that instantiates this hybrid standard. From Diem.
* [MultiToken](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/MultiToken.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - An ERC1155-like token. From Diem.
* [NFTGallery](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/NFTGallery.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - Utility for holding multiple NFT's of the same type. From Diem.
* [NFT examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/nfts) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 - Multiple NFT example implementations from Sui.
...
* [DeFi examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/defi) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 - Multiple DeFi example implementations from Sui.
...
* [DiemSystem](https://github.com/diem/diem/blob/main/diem-move/diem-framework/DPN/sources/DiemSystem.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - Validator set management. From Diem.
* [Vote](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/Vote.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - On-chain voting. From Diem.
...
* [Account](https://github.com/diem/diem/blob/main/diem-move/diem-framework/core/sources/Account.move) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01 - A generic account for Diem-powered chains. From Diem.
...
* [Diem Framework](https://github.com/diem/diem/tree/main/diem-move/diem-framework/DPN) ⭐ 16,667 | 🐛 368 | 🌐 Rust | 📅 2026-09-01
* [Sui Framework](https://github.com/MystenLabs/sui/tree/main/crates/sui-framework) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02
* [Aptos Framework](https://github.com/aptos-labs/aptos-core/tree/main/aptos-move/framework) ⭐ 6,428 | 🐛 557 | 🌐 Rust | 📅 2026-09-02
...
* [Sui Wallet](https://github.com/MystenLabs/sui/tree/main/apps/wallet) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 - A chrome (v88+) extension wallet for Sui ([Chrome Webstore](https://chrome.google.com/webstore/detail/sui-wallet/opcgpfmipidbgpenhmajoajpbobppdil)).
...
* [Sui Wallet](https://github.com/MystenLabs/sui/tree/main/sdk/wallet-adapter) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 - Sui Wallet Adapter.
...
* [TS/JS SDK](https://github.com/MystenLabs/sui/tree/main/sdk/typescript) ⭐ 7,741 | 🐛 822 | 🌐 Rust | 📅 2026-09-02 (official)
* [Python SDK](https://github.com/FrankC01/pysui) ⭐ 212 | 🐛 2 | 🌐 Python | 📅 2026-08-25 (community)
* [Golang SDK 2](https://github.com/block-vision/sui-go-sdk) ⭐ 198 | 🐛 17 | 🌐 Go | 📅 2026-08-12 (community)
