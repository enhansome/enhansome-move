...
* [Problem Statement](https://github.com/mystenlabs/awesome-move/blob/main/docs/problem_statement.md#problem-statement) ⭐ 1,498 | 🐛 24 | 📅 2024-08-14

## Move-Powered Blockchains

* [Diem](https://github.com/diem/diem) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - The original Move based blockchain from Meta (form. Libra by Facebook) (discontinued).
* [Sui](https://github.com/MystenLabs/sui) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 - A next-generation smart contract platform with high throughput, low latency, and an asset-oriented programming model powered by the Move programming language (in [devnet](https://medium.com/mysten-labs/sui-devnet-public-release-a2be304ff36b)).
* [Aptos](https://github.com/aptos-labs/aptos-core) ⭐ 6,440 | 🐛 564 | 🌐 Rust | 📅 2026-08-13 - Aptos-core strives towards being the safest and most scalable layer one blockchain solution (in [mainnet](https://explorer.aptoslabs.com/?network=mainnet)).
* [Starcoin](https://github.com/starcoinorg/starcoin) ⭐ 1,155 | 🐛 240 | 🌐 Rust | 📅 2026-08-13 - A smart contract blockchain network that scales by layering (in [mainnet](https://stcscan.io/)).
...
* [Fungible token examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/fungible_tokens) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 - Multiple example token implementations from Sui.
...
* [NFT](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/NFT.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - An implementation of a hybrid ERC721/ERC1155-like token. From Diem.
* [BARS](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/BARS.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - An NFT that instantiates this hybrid standard. From Diem.
* [MultiToken](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/MultiToken.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - An ERC1155-like token. From Diem.
* [NFTGallery](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/NFTGallery.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - Utility for holding multiple NFT's of the same type. From Diem.
* [NFT examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/nfts) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 - Multiple NFT example implementations from Sui.
...
* [MoveDID](https://github.com/NonceGeek/MoveDID) ⭐ 35 | 🐛 8 | 🌐 Move | 📅 2025-04-03 - MoveDID is a DID protocol that compatible with Move-based blockchain networks, including Aptos, Sui, and Starcoin. Maintained by the [NonceGeek](https://github.com/NonceGeek).
* [aptos-cid](https://github.com/coming-chat/aptos-cid) ⭐ 7 | 🐛 0 | 🌐 Move | 📅 2022-11-01 - Decentralized identity on Aptos, the underlying account system of ComingChat.

### DeFi

* [DeFi examples](https://github.com/MystenLabs/sui/tree/main/sui_programmability/examples/defi) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 - Multiple DeFi example implementations from Sui.
...
* [DiemSystem](https://github.com/diem/diem/blob/main/diem-move/diem-framework/DPN/sources/DiemSystem.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - Validator set management. From Diem.
* [Vote](https://github.com/diem/diem/blob/main/diem-move/diem-framework/experimental/sources/Vote.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - On-chain voting. From Diem.
...
* [OmniBTC Bridge](https://github.com/OmniBTC/OmniBridge) ⭐ 35 | 🐛 1 | 🌐 Move | 📅 2022-10-31 - A bridge between Bitcoin and Move language public chains (like Aptos and Sui) based on ultra-light node.
...
* [Account](https://github.com/diem/diem/blob/main/diem-move/diem-framework/core/sources/Account.move) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12 - A generic account for Diem-powered chains. From Diem.
...
* [Diem Framework](https://github.com/diem/diem/tree/main/diem-move/diem-framework/DPN) ⭐ 16,668 | 🐛 377 | 🌐 Rust | 📅 2026-08-12
* [Sui Framework](https://github.com/MystenLabs/sui/tree/main/crates/sui-framework) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13
* [Aptos Framework](https://github.com/aptos-labs/aptos-core/tree/main/aptos-move/framework) ⭐ 6,440 | 🐛 564 | 🌐 Rust | 📅 2026-08-13
...
* [Movemate](https://github.com/pentagonxyz/movemate) ⭐ 210 | 🐛 6 | 🌐 Move | 📅 2022-12-19 - Smart contract building blocks for Aptos and Sui (Math utilities, governance contracts, escrow, and more). Maintained by the Pentagon team.
...
* [Sui Wallet](https://github.com/MystenLabs/sui/tree/main/apps/wallet) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 - A chrome (v88+) extension wallet for Sui ([Chrome Webstore](https://chrome.google.com/webstore/detail/sui-wallet/opcgpfmipidbgpenhmajoajpbobppdil)).
...
* [Sui Wallet](https://github.com/MystenLabs/sui/tree/main/sdk/wallet-adapter) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 - Sui Wallet Adapter.
...
* [TS/JS SDK](https://github.com/MystenLabs/sui/tree/main/sdk/typescript) ⭐ 7,735 | 🐛 808 | 🌐 Rust | 📅 2026-08-13 (official)
* [Python SDK](https://github.com/FrankC01/pysui) ⭐ 212 | 🐛 5 | 🌐 Python | 📅 2026-08-12 (community)
